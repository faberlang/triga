...
**Status**: Units 1–7 implemented on packet — explicit attribute/layout facts,
...
normals, planar UVs, and validated plane/box/circle primitives in `src/geometry.fab`
