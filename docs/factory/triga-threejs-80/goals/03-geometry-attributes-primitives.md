...
**Status**: Units 1–3 implemented on packet — attribute/layout contract,
structural geometry validation, and position-derived bounding boxes and spheres;
generated normals/UVs, reflection, and primitive families remain
