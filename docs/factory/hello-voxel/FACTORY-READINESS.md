...
| HV-04 Indexed cube crossover | READY | waits for HV-01, HV-02, HV-03 | [`deliveries/04-indexed-cube-crossover-delivery.md`](deliveries/04-indexed-cube-crossover-delivery.md) | pending |
...
facts. The first remaining executable gate is the Radix-owned HV-00B red
fixture pass. No full unit is complete, and no release is authorized.
