...
construction, point and box containment, `Box3` union for aggregate chunk or
selection bounds, camera yaw/pitch ray construction, ray-to-`Box3` entry
distance, and `RayBox3Hit` distance/point/normal facts for selection
